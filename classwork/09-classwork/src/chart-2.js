...
var margin = { top: 10, left: 20, right: 10, bottom: 30 }
...
function ready(datapoints) {
  ...
  // We have 6 groups of data - we want 6 svgs
  ...
  container
    ...
    .each(function(d) {
      ...
      svg
        ...
        .text(name)
        .attr('x', width / 2)
        // Actually centre-align the text
        .attr('texg-anchor', 'middle')
        // dy -- think of it as the offset from the 'real' y
        .attr('dy', -10)
