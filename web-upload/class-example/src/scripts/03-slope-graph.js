...
function ready(datapoints) {
  ...
  svg
    ...
    .attr('class', d => {
      return d.state.replace(/[^\w]/g, '').toLowerCase()
    })
    .on('mouseover', function(d, i) {
      console.log('mouseover on', this)
      svg
        .selectAll('.' + this.getAttribute('class'))
        .attr('fill', 'red')
        .raise()
      svg.selectAll('path.' + this.getAttribute('class')).attr('stroke', 'red')
    })
    .raise()
    .on('mouseout', function(d) {
      ...
      svg
        .selectAll('path.' + this.getAttribute('class'))
